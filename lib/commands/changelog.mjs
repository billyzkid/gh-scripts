...
const yargs = new Yargs()
  ...
  .example("gh-scripts changelog -r v1.0.0.. -x robot -f ./CHANGELOG.md -e utf8", "Generate a changelog for the commits tagged v1.0.0 or later (excluding \"robot\" authors) and output it to the specified file (using utf-8 encoding)")
