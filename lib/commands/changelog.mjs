...
const yargs = new Yargs()
  ...
  .option("group-by-release", {
    alias: "gr",
    describe: "Group the changelog by release",
    type: "boolean",
    default: true,
    nargs: 0
  })
  .option("group-by-label", {
    alias: "gl",
    describe: "Group the changelog by label",
    type: "boolean",
    default: true,
    nargs: 0
  })
  .option("group-by-path", {
    alias: "gp",
    describe: "Group the changelog by path",
    type: "boolean",
    default: true,
    nargs: 0
  })
